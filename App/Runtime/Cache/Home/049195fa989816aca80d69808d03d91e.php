...
<form id="post-tool" style="padding:5px;">
    <div class="tool-opt">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconCls="icon-reload" onclick="postOpt.reload()">刷新</a>
...
<form id="post-add">
    <table class="form-table">
        <tbody>
        <tr>
            <td class="label"><label for="post-add-name" class="form-label">职位名称</label></td>
            <td class="input"><input type="text" id="post-add-name"/></td>
        </tr>
        </tbody>
    </table>
</form>
...
<form id="post-edit">
    ...
    <table class="form-table">
        <tbody>
        <tr>
            <td class="label"><label for="post-edit-name" class="form-label">职位名称</label></td>
            <td class="input"><input type="text" id="post-edit-name" name="name"/></td>
        </tr>
        </tbody>
    </table>
</form>
