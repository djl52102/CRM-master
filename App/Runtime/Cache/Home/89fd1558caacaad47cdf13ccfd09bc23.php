...
<form id="payment-tool" style="padding:5px;">
  <div class="tool-opt">
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconCls="icon-reload" onclick="paymentOpt.reload()">刷新</a>
...
<script type="text/javascript" src="/CRM/Public/js/payment.js"></script>