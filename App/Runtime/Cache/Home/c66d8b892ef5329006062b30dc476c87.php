...
<div data-options="region:'north',split:true,border:false" class="layout-north">
  <div class="logo">
    <img src="/CRM/Public/image/logo.png" alt="CRM客户管理系统">
  </div>
  <div class="info">
...
<form id="edit" class="easyui-dialog">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td class="input"><input type="text" id="edit-accounts" class="easyui-textbox" value="<?php echo session('admin')['accounts'];?>"/></td>
        </tr>
        <tr>
